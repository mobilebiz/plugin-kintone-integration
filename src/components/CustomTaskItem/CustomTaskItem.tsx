...
const { FLEX_APP_KINTONE_CUSTOMER_APP_ID } = process.env;
...
const CustomTaskItem = (props: any): JSX.Element | null => {
  ...
  const url = props.task.attributes.recordId
    ? `https://twilio.cybozu.com/k/${FLEX_APP_KINTONE_CUSTOMER_APP_ID}/show#record=${props.task.attributes.recordId}`
    : `https://twilio.cybozu.com/k/${FLEX_APP_KINTONE_CUSTOMER_APP_ID}/edit?`;
